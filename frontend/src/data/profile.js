...
const projectsBase = [
  {
    ...
    zh: {
      name: '墨架 · InkShelf',
      summary:
        'Flutter 本地小说阅读器：Android / iOS 一套代码，三 Tab（书架 / 书源 / 设置），本地书架 + 可配置书源，不预置任何书城。',
      bullets: [
        '本地 TXT 导入、编码识别、自动分章；书架封面网格与搜索、书籍详情、书源章节刷新',
        '阅读三模式（左右翻页 / 上下滚动 / 仿真翻页）；进度记忆、目录与书签、字号行距、昼夜主题、自动阅读、听书 TTS、亮度跟随系统',
        '书源引擎兼容阅读 / Legado 风格 JSON：粘贴导入与导出分享、跨源模糊 / 精准搜索、按章拉取并本地缓存',
        'Riverpod 状态管理；无 Mac 时 Codemagic 云构建未签名 IPA / release APK，Sideloadly 装到 iPhone 自用',
      ],
    },
    en: {
      name: 'InkShelf',
      summary:
        'Flutter local novel reader — one codebase for Android / iOS, three tabs (shelf / sources / settings), local shelf plus configurable sources, no built-in store.',
      bullets: [
        'Import local TXT with encoding detection and auto chapter split; cover-grid shelf with search, book detail, and source chapter refresh',
        'Three reading modes (horizontal flip / vertical scroll / page-curl); progress memory, TOC & bookmarks, font size/leading, day/night theme, auto-scroll, TTS, system brightness',
        'Book-source engine compatible with Legado-style JSON: paste/import and export/share, cross-source fuzzy or exact search, chapter fetch into local cache',
        'Riverpod state; Codemagic cloud builds unsigned IPA / release APK without a Mac, install on iPhone with Sideloadly',
      ],
    },
  },
  {
