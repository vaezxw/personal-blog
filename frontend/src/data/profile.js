...
export const profile = {
  ...
  summary: [
    '3 年前端经验，现任职博彦科技（上海），主攻 Vue 生态与企业级 B 端 / 移动端交付。',
    '2026 年 4 月入职后快速承担设备生命周期、营收 3.0、智慧工单 App、三端合同签署等多线并行开发，已提前转正。',
...
export const projects = [
  ...
  },
  {
    ...
    summary: '燃气营收核心系统：档案、报表、限购、开户审核、流量计详情、告警配置等。',
    bullets: [
  ...
  },
  {
    ...
    summary: '燃气智慧工作台：安检、工单、简易开户、基表抄表、审核时间线等移动端能力。',
    bullets: [
  ...
  },
  {
    ...
    role: '前端参与',
    tech: ['vue3', 'mqtt', 'js'],
    summary: '恒光工业流程图：IoT 平台图标搭建、监测点位置调整与 MQTT 数据联调。',
    bullets: [
      'MaoBao-AIoT 平台流程搭建与监测点展示优化',
      '监测点排序与 MQTT 新增点位数据问题推动后端排查',
    ],
  },
  {
    id: 'grid-platform',
